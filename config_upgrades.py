        ...
        'rover': {
            ...
            'levels': {
                1: {
                    ...
                    'cargo': 10, 'expedition_speed_mult': 3.0, 'max_range_km': 300, 'fuel_cost_mult': 1.0,
                ...
                2: {
                    ...
                    'cargo': 11, 'expedition_speed_mult': 3.5, 'max_range_km': 350, 'fuel_cost_mult': 1.0,
                ...
                3: {
                    ...
                    'cargo': 12, 'expedition_speed_mult': 4.0, 'max_range_km': 400, 'fuel_cost_mult': 1.0,
                ...
                4: {
                    'name': 'Terrain Crawler', 'cost': 627, 'build_time_days': 3,
                    'cargo': 13, 'expedition_speed_mult': 5.0, 'max_range_km': 500, 'fuel_cost_mult': 0.95,
                ...
                5: {
                    'name': 'Regolith Runner', 'cost': 703, 'build_time_days': 5,
                    'cargo': 14, 'expedition_speed_mult': 5.5, 'max_range_km': 600, 'fuel_cost_mult': 0.95,
                ...
                6: {
                    'name': 'Basalt Hauler', 'cost': 787, 'build_time_days': 7,
                    'cargo': 16, 'expedition_speed_mult': 6.5, 'max_range_km': 700, 'fuel_cost_mult': 0.90,
                ...
                7: {
                    'name': 'Stone Serpent', 'cost': 881, 'build_time_days': 9,
                    'cargo': 17, 'expedition_speed_mult': 7.0, 'max_range_km': 800, 'fuel_cost_mult': 0.90,
                ...
                8: {
                    'name': 'Dust Devil', 'cost': 987, 'build_time_days': 11,
                    'cargo': 19, 'expedition_speed_mult': 8.0, 'max_range_km': 950, 'fuel_cost_mult': 0.85,
                ...
                9: {
                    'name': 'Mars Leviathan', 'cost': 1105, 'build_time_days': 13,
                    'cargo': 21, 'expedition_speed_mult': 9.0, 'max_range_km': 1100, 'fuel_cost_mult': 0.80,
                ...
                10: {
                    'name': 'Titan Transport', 'cost': 1386, 'build_time_days': 14,
                    'cargo': 24, 'expedition_speed_mult': 10.0, 'max_range_km': 1200, 'fuel_cost_mult': 0.75,
        ...
        'drone': {
            ...
            'levels': {
                1: {
                    ...
                    'cargo': 4, 'expedition_speed_mult': 4.0, 'max_range_km': 150, 'fuel_cost_mult': 1.10,
                ...
                2: {
                    ...
                    'cargo': 5, 'expedition_speed_mult': 4.5, 'max_range_km': 180, 'fuel_cost_mult': 1.05,
                ...
                3: {
                    ...
                    'cargo': 6, 'expedition_speed_mult': 5.0, 'max_range_km': 220, 'fuel_cost_mult': 1.0,
                ...
                4: {
                    ...
                    'cargo': 6, 'expedition_speed_mult': 5.5, 'max_range_km': 260, 'fuel_cost_mult': 1.0,
                ...
                5: {
                    ...
                    'cargo': 7, 'expedition_speed_mult': 6.0, 'max_range_km': 300, 'fuel_cost_mult': 0.95,
                ...
                6: {
                    ...
                    'cargo': 7, 'expedition_speed_mult': 6.5, 'max_range_km': 350, 'fuel_cost_mult': 0.95,
                ...
                7: {
                    ...
                    'cargo': 8, 'expedition_speed_mult': 7.0, 'max_range_km': 400, 'fuel_cost_mult': 0.90,
                ...
                8: {
                    'name': 'Drone Mk VIII', 'cost': 11053, 'build_time_days': 11,
                    'cargo': 8, 'expedition_speed_mult': 7.5, 'max_range_km': 450, 'fuel_cost_mult': 0.90,
                ...
                9: {
                    'name': 'Drone Mk IX', 'cost': 12380, 'build_time_days': 13,
                    'cargo': 9, 'expedition_speed_mult': 8.0, 'max_range_km': 500, 'fuel_cost_mult': 0.85,
                ...
                10: {
                    'name': 'Drone Mk X', 'cost': 13865, 'build_time_days': 14,
                    'cargo': 10, 'expedition_speed_mult': 9.0, 'max_range_km': 600, 'fuel_cost_mult': 0.85,
        ...
        'buggy': {
            ...
            'levels': {
                1: {
                    ...
                    'cargo': 6, 'expedition_speed_mult': 6.0, 'max_range_km': 1500, 'fuel_cost_mult': 0.90,
                ...
                2: {
                    'name': 'Desert Runner', 'cost': 5600, 'build_time_days': 3,
                    'cargo': 7, 'expedition_speed_mult': 6.5, 'max_range_km': 1800, 'fuel_cost_mult': 0.88,
                ...
                3: {
                    'name': 'Dune Skimmer', 'cost': 6272, 'build_time_days': 4,
                    'cargo': 8, 'expedition_speed_mult': 7.0, 'max_range_km': 2100, 'fuel_cost_mult': 0.85,
                    'discovery_bonus': 0, 'rare_bonus': 0, 'legendary_bonus': -0.15,
                    'image_url': '',
                },
                4: {
                    'name': 'Canyon Racer', 'cost': 7025, 'build_time_days': 5,
                    'cargo': 8, 'expedition_speed_mult': 7.5, 'max_range_km': 2400, 'fuel_cost_mult': 0.83,
                    'discovery_bonus': 0.02, 'rare_bonus': 0, 'legendary_bonus': -0.10,
                    'image_url': '',
                },
                5: {
                    'name': 'Frontier Sprinter', 'cost': 7868, 'build_time_days': 7,
                    'cargo': 9, 'expedition_speed_mult': 8.0, 'max_range_km': 2700, 'fuel_cost_mult': 0.80,
                    'discovery_bonus': 0.05, 'rare_bonus': 0, 'legendary_bonus': -0.05,
                    'image_url': '',
                },
                6: {
                    'name': 'Valles Runner', 'cost': 8812, 'build_time_days': 8,
                    'cargo': 9, 'expedition_speed_mult': 8.5, 'max_range_km': 3000, 'fuel_cost_mult': 0.78,
                    'discovery_bonus': 0.05, 'rare_bonus': 0.02, 'legendary_bonus': 0,
                    'image_url': '',
                },
                7: {
                    'name': 'Storm Chaser', 'cost': 9869, 'build_time_days': 10,
                    'cargo': 10, 'expedition_speed_mult': 9.0, 'max_range_km': 3300, 'fuel_cost_mult': 0.75,
                    'discovery_bonus': 0.08, 'rare_bonus': 0.05, 'legendary_bonus': 0,
                    'image_url': '',
                },
                8: {
                    'name': 'Olympus Climber', 'cost': 11053, 'build_time_days': 11,
                    'cargo': 10, 'expedition_speed_mult': 9.5, 'max_range_km': 3600, 'fuel_cost_mult': 0.73,
                    'discovery_bonus': 0.08, 'rare_bonus': 0.05, 'legendary_bonus': 0.02,
                    'image_url': '',
                },
                9: {
                    'name': 'Polar Express', 'cost': 12380, 'build_time_days': 13,
                    'cargo': 11, 'expedition_speed_mult': 10.0, 'max_range_km': 4000, 'fuel_cost_mult': 0.70,
                    'discovery_bonus': 0.10, 'rare_bonus': 0.08, 'legendary_bonus': 0.03,
                    'image_url': '',
                },
                10: {
                    'name': 'Mars Phantom', 'cost': 13865, 'build_time_days': 14,
                    'cargo': 12, 'expedition_speed_mult': 11.0, 'max_range_km': 4500, 'fuel_cost_mult': 0.68,
                    'discovery_bonus': 0.10, 'rare_bonus': 0.10, 'legendary_bonus': 0.05,
                    'image_url': '',
                },
            }
    ...
    'equipment': {
        ...
        'life_support': {
            ...
            'levels': {
                ...
                4: {
                    'name': 'Biosphere Module', 'cost': 843, 'build_time_days': 3,
                    'life_support_cost_mult': 0.75,
                    'image_url': '',
                },
                5: {
                    'name': 'Atmospheric Processor', 'cost': 944, 'build_time_days': 5,
                    'life_support_cost_mult': 0.70,
                    'image_url': '',
                },
                6: {
                    'name': 'Mars Air Forge', 'cost': 1058, 'build_time_days': 7,
                    'life_support_cost_mult': 0.65,
                    'image_url': '',
                },
                7: {
                    'name': 'Regolith Breather', 'cost': 1185, 'build_time_days': 9,
                    'life_support_cost_mult': 0.60,
                    'image_url': '',
                },
                8: {
                    'name': 'Deep Filter Array', 'cost': 1327, 'build_time_days': 10,
                    'life_support_cost_mult': 0.55,
                    'image_url': '',
                },
                9: {
                    'name': 'Martian Lung', 'cost': 1486, 'build_time_days': 12,
                    'life_support_cost_mult': 0.52,
                    'image_url': '',
                },
                10: {
                    'name': 'Self-Sustaining Hab', 'cost': 1664, 'build_time_days': 14,
        ...
        'cargo': {
            ...
            'levels': {
                ...
                4: {
                    'name': 'Cryo Storage I', 'cost': 1054, 'build_time_days': 4,
                ...
                5: {
                    'name': 'Cryo Storage II', 'cost': 1180, 'build_time_days': 6,
                    'cargo_slots': 6, 'bio_discovery_value_mult': 1.15,
                    'image_url': '',
                },
                6: {
                    'name': 'Specimen Hold', 'cost': 1322, 'build_time_days': 7,
                    'cargo_slots': 7, 'bio_discovery_value_mult': 1.15,
                    'image_url': '',
                },
                7: {
                    'name': 'Deep Specimen Hold', 'cost': 1480, 'build_time_days': 9,
                    'cargo_slots': 8, 'bio_discovery_value_mult': 1.20,
                    'image_url': '',
                },
                8: {
                    'name': 'Heavy Cargo Module', 'cost': 1658, 'build_time_days': 10,
                    'cargo_slots': 9, 'bio_discovery_value_mult': 1.20,
                    'image_url': '',
                },
                9: {
                    'name': 'Expedition Hold', 'cost': 1857, 'build_time_days': 12,
                    'cargo_slots': 10, 'bio_discovery_value_mult': 1.25,
                    'image_url': '',
                },
                10: {
                    'name': 'Mars Vault', 'cost': 2080, 'build_time_days': 14,
    ...
    'power': {
        'generator': {
            ...
            'levels': {
                ...
                4: {
                    'name': 'Shard Resonator', 'cost': 1405, 'build_time_days': 4,
                    'passive_income_mult': 1.28,
                    'image_url': '',
                },
                5: {
                    'name': 'Shard Excitation Core', 'cost': 1573, 'build_time_days': 6,
                    'passive_income_mult': 1.33,
                    'image_url': '',
                },
                6: {
                    'name': 'Deep Frequency Array', 'cost': 1762, 'build_time_days': 7,
                    'passive_income_mult': 1.40,
                    'image_url': '',
                },
                7: {
                    'name': 'Resonant Amplifier', 'cost': 1973, 'build_time_days': 9,
                    'passive_income_mult': 1.46,
                    'image_url': '',
                },
                8: {
                    'name': 'Harmonic Exciter', 'cost': 2210, 'build_time_days': 10,
                    'passive_income_mult': 1.54,
                    'image_url': '',
                },
                9: {
                    'name': 'Sepolia Shard Forge', 'cost': 2475, 'build_time_days': 12,
                    'passive_income_mult': 1.60,
                    'image_url': '',
                },
                10: {
                    'name': 'Shard Singularity Core', 'cost': 2773, 'build_time_days': 14,
    ...
    'research': {
        'research': {
            ...
            'levels': {
                ...
                4: {
                    'name': 'Specimen Chamber', 'cost': 2107, 'build_time_days': 5,
                ...
                5: {
                    'name': 'Research Center', 'cost': 2360, 'build_time_days': 6,
                ...
                6: {
                    'name': 'Deep Analysis Array', 'cost': 2643, 'build_time_days': 8,
                ...
                7: {
                    'name': 'Martian Institute', 'cost': 2960, 'build_time_days': 9,
                ...
                8: {
                    'name': 'Xenolab Complex', 'cost': 3315, 'build_time_days': 11,
                ...
                9: {
                    'name': 'Advanced Research Hub', 'cost': 3713, 'build_time_days': 13,
                ...
                10: {
                    'name': 'Mars Science Academy', 'cost': 4159, 'build_time_days': 14,
    ...
    'gear': {
        'suit': {
            ...
            'levels': {
                ...
                4: {
                    'name': 'Command Suit', 'cost': 1124, 'build_time_days': 4,
                ...
                5: {
                    'name': 'Hauler Frame', 'cost': 1259, 'build_time_days': 6,
                ...
                6: {
                    'name': 'Tactical Suit', 'cost': 1410, 'build_time_days': 7,
                    'stat_exploration_bonus': 6,
                    'image_url': '',
                },
                7: {
                    'name': 'Regolith Armor', 'cost': 1579, 'build_time_days': 9,
                    'stat_exploration_bonus': 7,
                    'image_url': '',
                },
                8: {
                    'name': 'Mars Exosuit', 'cost': 1768, 'build_time_days': 10,
                    'stat_exploration_bonus': 8,
                    'image_url': '',
                },
                9: {
                    'name': 'Frontier Harness', 'cost': 1981, 'build_time_days': 12,
                    'stat_exploration_bonus': 9,
                    'image_url': '',
                },
                10: {
                    'name': 'Titan Exoframe', 'cost': 2218, 'build_time_days': 14,
        ...
        'automation': {
            ...
            'levels': {
                1: {
                    ...
                    'passive_income_base': 3, 'dust_storm_immune': False,
                ...
                2: {
                    ...
                    'passive_income_base': 5, 'dust_storm_immune': False,
                    'image_url': '',
                },
                3: {
                    'name': 'Dust Guard', 'cost': 3136, 'build_time_days': 4,
                    'passive_income_base': 7, 'dust_storm_immune': True,
                    'image_url': '',
                },
                4: {
                    'name': 'Mining Drone I', 'cost': 3512, 'build_time_days': 6,
                    'passive_income_base': 9, 'dust_storm_immune': True,
                ...
                5: {
                    ...
                    'passive_income_base': 12, 'dust_storm_immune': True,
                    'image_url': '',
                },
                6: {
                    'name': 'Extraction Swarm', 'cost': 4406, 'build_time_days': 9,
                    'passive_income_base': 15, 'dust_storm_immune': True,
                    'image_url': '',
                },
                7: {
                    'name': 'Deep Miner', 'cost': 4935, 'build_time_days': 10,
                    'passive_income_base': 18, 'dust_storm_immune': True,
                    'image_url': '',
                },
                8: {
                    'name': 'Regolith Processor', 'cost': 5527, 'build_time_days': 11,
                    'passive_income_base': 22, 'dust_storm_immune': True,
                    'image_url': '',
                },
                9: {
                    'name': 'Autonomous Excavator', 'cost': 6190, 'build_time_days': 13,
                    'passive_income_base': 26, 'dust_storm_immune': True,
                    'image_url': '',
                },
                10: {
                    'name': 'Mars Mining Matrix', 'cost': 6933, 'build_time_days': 14,
                    'passive_income_base': 30, 'dust_storm_immune': True,
                    'image_url': '',
                },
            }
        },
