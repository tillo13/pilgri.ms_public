    ...
    'exploration': {
        ...
        'techs': {
            'wind_analysis': {
                ...
                'tier': 1,
                'base_cost_sv': 5000,
                'description': 'Study wind patterns to optimize flight paths. 1.25x expedition speed.',
            ...
            'terrain_mapping': {
                ...
                'tier': 1,
                'base_cost_sv': 5000,
                'description': 'Chart surface features for better routes. 1.10x discovery chance.',
            ...
            'storm_prediction': {
                ...
                'tier': 2,
                'base_cost_sv': 12000,
                'description': 'Forecast atmospheric anomalies — storm-exposed strata surface rare mineral deposits. 1.08x rare discovery chance.',
                'effects': {'rare_chance_bonus': 0.08},
            ...
            'advanced_sensors': {
                ...
                'tier': 2,
                'base_cost_sv': 12000,
                'description': 'Upgraded arrays spot deposits further away. 1.20x discovery chance.',
            ...
            'deep_scanning': {
                ...
                'tier': 3,
                'base_cost_sv': 25000,
                'description': 'Penetrating scans reveal rare formations. 1.05x legendary discovery.',
    ...
    'vehicles': {
        ...
        'techs': {
            'material_science': {
                ...
                'tier': 1,
                'base_cost_sv': 5000,
                'description': 'Martian rock composites for stronger frames. 1.15x cargo capacity.',
            ...
            'suspension_engineering': {
                ...
                'tier': 1,
                'base_cost_sv': 5000,
                'description': 'Adapt suspension for rough terrain. 1.10x expedition speed.',
            ...
            'nav_computation': {
                ...
                'tier': 2,
                'base_cost_sv': 12000,
                'description': 'Route optimization reduces fuel waste. 0.90x fuel cost.',
            ...
            'all_terrain_mastery': {
                ...
                'tier': 3,
                'base_cost_sv': 30000,
                'description': 'Master every Martian surface. 1.30x speed, 1.20x cargo.',
    ...
    'power': {
        ...
        'techs': {
            'solar_optimization': {
                ...
                'tier': 1,
                'base_cost_sv': 5000,
                'description': 'Optimize panel angles for Mars sunlight. 1.20x passive income.',
            ...
            'battery_chemistry': {
                ...
                'tier': 1,
                'base_cost_sv': 5000,
                'description': 'Better charge storage for night generation. 1.25x night generation.',
            ...
            'thermal_tap': {
                ...
                'tier': 2,
                'base_cost_sv': 12000,
                'description': 'Tap thermal vents to excite shard deposits. 1.30x passive income.',
            ...
            'power_grid': {
                ...
                'tier': 2,
                'base_cost_sv': 12000,
                'description': 'Efficient distribution network. 1.10x all generation.',
            ...
            'fusion_basics': {
                ...
                'tier': 3,
                'base_cost_sv': 35000,
                'description': 'Early fusion experiments. 1.50x passive income.',
    ...
    'extraction': {
        ...
        'techs': {
            'shard_resonance': {
                ...
                'tier': 1,
                'base_cost_sv': 5000,
                'description': 'Tune to Sepolia crystal frequency. 1.10x discovery value.',
            ...
            'specimen_preservation': {
                ...
                'tier': 1,
                'base_cost_sv': 5000,
                'description': 'Seal samples to prevent degradation. 1.20x bio value.',
            ...
            'crystal_attunement': {
                ...
                'tier': 2,
                'base_cost_sv': 12000,
                'description': 'Deeper tuning extracts more. 1.25x discovery value.',
            ...
            'xenobiology_mastery': {
                ...
                'tier': 2,
                'base_cost_sv': 12000,
                'description': 'Advanced techniques reduce costs. 0.75x xenolab cost.',
            ...
            'ancient_protocols': {
                ...
                'tier': 3,
                'base_cost_sv': 50000,
                'description': 'Decode ancient crystal patterns. 1.40x value, 1.20x extraction.',
