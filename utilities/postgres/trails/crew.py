...
# Bug #1430 (Luke 2026-04-29): get_trail_consumable_discoveries and
# consume_discovery_for_trail deleted along with the scanner+consumable
# trail-speed-bonus loop. The UI section + JS + Python paths all rip together.
