...
from utilities.postgres_utils import db_cursor, _fetchone, _fetchall, _get_one, _get_many, _update, _count
        ...
        with db_cursor() as cur:
            ...
            cur.execute("""
                SELECT di.id as discovery_item_id, di.item_name, di.item_type, di.rarity, di.description,
                       ...
                       SUM(ed.enhanced_value) as enhanced_value, MAX(ed.claimed_at) as claimed_at,
