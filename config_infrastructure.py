...
INFRASTRUCTURE_CATALOG = {
    ...
    'solar_array': {
        ...
        'levels': {
            ...
            4: {
                'name': 'Concentrated Collector', 'cost': 627, 'build_time_days': 3,
                'generation_rate': 18.0,
                'image_url': '',
            },
            5: {
                'name': 'Mirror Array', 'cost': 703, 'build_time_days': 5,
                'generation_rate': 22.0,
                'image_url': '',
            },
            6: {
                'name': 'Regolith Solar Farm', 'cost': 787, 'build_time_days': 7,
                'generation_rate': 27.0,
                'image_url': '',
            },
            7: {
                'name': 'Crystal-Laced Collectors', 'cost': 881, 'build_time_days': 9,
                'generation_rate': 33.0,
                'image_url': '',
            },
            8: {
                'name': 'Resonant Solar Grid', 'cost': 987, 'build_time_days': 11,
                'generation_rate': 40.0,
                'image_url': '',
            },
            9: {
                'name': 'Sepolia Excitation Array', 'cost': 1105, 'build_time_days': 13,
                'generation_rate': 50.0,
                'image_url': '',
            },
            10: {
                'name': 'Monolithic Power Station', 'cost': 1238, 'build_time_days': 14,
    ...
    'battery_storage': {
        ...
        'levels': {
            ...
            4: {
                'name': 'Deep Cycle Bank', 'cost': 140, 'build_time_days': 3,
                'night_generation': 0.45,
                'image_url': '',
            },
            5: {
                'name': 'Regolith Capacitors', 'cost': 157, 'build_time_days': 5,
                'night_generation': 0.50,
                'image_url': '',
            },
            6: {
                'name': 'Crystal Cell Array', 'cost': 176, 'build_time_days': 7,
                'night_generation': 0.55,
                'image_url': '',
            },
            7: {
                'name': 'Resonant Storage', 'cost': 197, 'build_time_days': 9,
                'night_generation': 0.60,
                'image_url': '',
            },
            8: {
                'name': 'Sepolia Battery Core', 'cost': 221, 'build_time_days': 11,
                'night_generation': 0.70,
                'image_url': '',
            },
            9: {
                'name': 'Deep Resonance Bank', 'cost': 247, 'build_time_days': 13,
                'night_generation': 0.80,
                'image_url': '',
            },
            10: {
                'name': 'Perpetual Power Core', 'cost': 277, 'build_time_days': 14,
    ...
    'water_extractor': {
        ...
        'levels': {
            ...
            4: {
                'name': 'Permafrost Extractor', 'cost': 703, 'build_time_days': 4,
                'fuel_cost_reduction': 0.20,
                'image_url': '',
            },
            5: {
                'name': 'Aquifer Tap', 'cost': 787, 'build_time_days': 6,
                'fuel_cost_reduction': 0.24,
                'image_url': '',
            },
            6: {
                'name': 'Subsurface Mining Rig', 'cost': 881, 'build_time_days': 8,
                'fuel_cost_reduction': 0.28,
                'image_url': '',
            },
            7: {
                'name': 'Crystal-Aided Extractor', 'cost': 987, 'build_time_days': 10,
                'fuel_cost_reduction': 0.32,
                'image_url': '',
            },
            8: {
                'name': 'Deep Core Drill', 'cost': 1105, 'build_time_days': 11,
                'fuel_cost_reduction': 0.36,
                'image_url': '',
            },
            9: {
                'name': 'Resonant Water Mine', 'cost': 1238, 'build_time_days': 13,
                'fuel_cost_reduction': 0.40,
                'image_url': '',
            },
            10: {
                'name': 'Hydro Core Complex', 'cost': 1386, 'build_time_days': 14,
    ...
    'refinery': {
        ...
        'levels': {
            ...
            8: {
                'name': 'Sepolia Extraction Core', 'cost': 11053, 'build_time_days': 11,
                'generation_rate': 90.0,
                'image_url': '',
            },
            9: {
                'name': 'Resonant Processing Hub', 'cost': 12380, 'build_time_days': 13,
                'generation_rate': 110.0,
                'image_url': '',
            },
            10: {
                'name': 'Monolithic Refinery', 'cost': 13865, 'build_time_days': 14,
    ...
    'habitat_module': {
        ...
        'levels': {
            ...
            4: {
                'name': 'Colony Hub', 'cost': 1405, 'build_time_days': 4,
                'expedition_capacity': 3,
                'image_url': '',
            },
            5: {
                'name': 'Regolith Bunker', 'cost': 1573, 'build_time_days': 6,
                'expedition_capacity': 3,
                'image_url': '',
            },
            6: {
                'name': 'Underground Complex', 'cost': 1762, 'build_time_days': 8,
                'expedition_capacity': 4,
                'image_url': '',
            },
            7: {
                'name': 'Crystal-Laced Habitat', 'cost': 1973, 'build_time_days': 10,
                'expedition_capacity': 4,
                'image_url': '',
            },
            8: {
                'name': 'Resonant Living Core', 'cost': 2210, 'build_time_days': 11,
                'expedition_capacity': 5,
                'image_url': '',
            },
            9: {
                'name': 'Deep Mars Settlement', 'cost': 2475, 'build_time_days': 13,
                'expedition_capacity': 5,
                'image_url': '',
            },
            10: {
                'name': 'Monolithic Colony', 'cost': 2773, 'build_time_days': 14,
    ...
    'comms_array': {
        ...
        'levels': {
            ...
            8: {
                'name': 'Sepolia Resonance Relay', 'cost': 6632, 'build_time_days': 11,
                'discovery_bonus': 0.20,
                'image_url': '',
            },
            9: {
                'name': 'Ancient Signal Array', 'cost': 7428, 'build_time_days': 13,
                'discovery_bonus': 0.23,
                'image_url': '',
            },
            10: {
                'name': 'Deep Space Beacon', 'cost': 8319, 'build_time_days': 14,
    ...
    'regolith_forge': {
        ...
        'levels': {
            ...
            8: {
                'name': 'Sepolia Forge Complex', 'cost': 44214, 'build_time_days': 13,
                'generation_rate': 178.0, 'science_generation_rate': 7.0,
                'image_url': '',
            },
            9: {
                'name': 'Ancient Forge', 'cost': 49520, 'build_time_days': 14,
                'generation_rate': 214.0, 'science_generation_rate': 8.0,
                'image_url': '',
            },
            10: {
                'name': 'Monolithic Forge', 'cost': 55462, 'build_time_days': 14,
